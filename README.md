...
>
> ```go
> import reveniumfal "github.com/revenium/revenium-go-sdk/fal"
> ```
>
> This repository is consolidated into the unified SDK; please use `revenium-go-sdk/fal` going forward.
