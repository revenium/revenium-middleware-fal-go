...
const (
	...
	ModuleName = "github.com/revenium/revenium-middleware-fal-go"
...
// Format: revenium-middleware-fal-go@{version}
...
func GetMiddlewareSource() string {
	middlewareSourceOnce.Do(func() {
		...
		middlewareSourceVal = "revenium-middleware-fal-go@" + version
	})
